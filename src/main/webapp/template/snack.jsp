                        ...
                        <nav aria-label="#">
                            <ul class="pagination">
                                <li class="page-item active">
                                    <a class="page-link" href="snack.do">CGV<span class="sr-only">(current)</span></a>
                                </li>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-post wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <div class="post-content">
                            ...
                            <a href="#">
                                <h4 class="post-headline">가족패키지</h4>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-post wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="post-content">
                            ...
                            <a href="#">
                                <h4 class="post-headline">감사선물 패키지</h4>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-post wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <div class="post-content">
                            ...
                            <a href="#">
                                <h4 class="post-headline">싱글패키지</h4>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-post wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <div class="post-content">
                            ...
                            <a href="#">
                                <h4 class="post-headline">커플패키지</h4>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-post wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <div class="post-content">
                            ...
                            <a href="#">
                                <h4 class="post-headline">콤보버라이어티팩</h4>
                            </a>
                        </div>
                    </div>
                </div>
